...
> 由 .github/workflows/self-check.yml 生成 · 2026-09-17T02:07:19Z
> 手动重跑：`python3 tools/self_check.py` 与 `python3 tools/rule_replay.py`

## 自检器
```
自检器 · 2026-09-17 02:07 UTC
==========================================================================
...
[C4] 预测记分卡  (1.1j：不记分就学不到)
  明细 13 条｜已记分 11（排除⊘）｜✅5 ❌5｜命中率 45.5%｜待验 5 条
  无到期未记分项
...
[4] 加速度条款触发率（1.1o 的门槛校准检查）
  ...
  各指标平均单日绝对变动（门槛是否该共用的依据）：
    term_structure   2.30%   (10% 门槛 = 其常态的 4.3 倍)
    skew             1.78%   (10% 门槛 = 其常态的 5.6 倍)
    vvix             3.02%   (10% 门槛 = 其常态的 3.3 倍)
    vix              4.05%   (10% 门槛 = 其常态的 2.5 倍)

[5] 期限溢价开窗率（VIX3M/VIX ≥ 1.20）
  开窗 17/36 天  (47.2%)   区间 1.106 – 1.295
