...
# ── 配置：改成你的报告标题 ─────────────────────────────────
REPORT_TITLE = "绿茶集团 6831.HK · 出清年份里的反向扩张"
...
ANCHORS = [
    ("摘要", r"^\s*—\s*摘要\s*$"),
    ("1　研究问题与证据基础", r"^\s*1\s*研究问题与证据基础\s*$"),
    ("2　行业背景：首次存量萎缩", r"^\s*2\s*行业背景：首次存量萎缩\s*$"),
    ("3　绿茶的增长来自哪里", r"^\s*3\s*绿茶的增长来自哪里\s*$"),
    ("4　在行业坐标系中的位置", r"^\s*4\s*在行业坐标系中的位置\s*$"),
    ("5　资本结构与市场定价", r"^\s*5\s*资本结构与市场定价\s*$"),
